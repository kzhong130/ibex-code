...
int main(int argc, char *argv[]) {
    ...
    cout << "Main: PIRServer pre-processing time: " << time_pre_us << " s"
         << endl;
    cout << "Main: PIRClient query generation time: " << time_query_us << " s"
         << endl;
    cout << "Main: PIRClient serialized query generation time: "
         << time_s_query_us << " s" << endl;
    cout << "Main: PIRServer query deserialization time: " << time_deserial_us
         << " s" << endl;
    cout << "Main: PIRServer reply generation time: " << time_server_us << " s"
         << endl;
    cout << "Main: PIRClient answer decode time: " << time_decode_us << " s"
         << endl;
    cout << "Main: Query size: " << query_size << " bytes" << endl;
    cout << "Main: Reply num ciphertexts: " << reply.size() << endl;
    cout << "Main: Reply size: " << reply_str.size() << " bytes" << endl;
